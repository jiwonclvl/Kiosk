...
public class Main {
    public static void main(String[] args) {
        ...
        menuItems.add(new MenuItem("ShackBurger", 6.9, "토마토, 양상추, 쉑소그가 토핑된 치즈버거"));
        menuItems.add(new MenuItem("SmokeShack", 8.9, "베이컨, 체리 페퍼에 쉑소그가 토핑된 치즈버거"));
        ...
        while (true) {
            ...
            try {
                ...
                if (choose == 0) {
                    ...
                    MenuItem chooseItem = menuItems.get(choose -1);
