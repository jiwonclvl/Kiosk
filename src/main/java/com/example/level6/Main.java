...
public class Main {
    public static void main(String[] args) {
        ...
        List<Menu> menuCategories = new ArrayList<>();

        //카테고리별 이름과 해당 메뉴 항목들을 배열에 저장
        menuCategories.add(new Menu("Burgers", burgers));
        menuCategories.add(new Menu("Drinks", drinks));
        ...
        Kiosk kiosk = new Kiosk(menuCategories);
        //메뉴 출력 및 사용자 입력 시작
        kiosk.start();
    }
}
